 ...
 */
class KWalletInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    KWalletInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
...
namespace org {
  namespace kde {
    typedef ::KWalletInterface KWallet;
  }
}
#endif
